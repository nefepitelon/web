...
const LOCAL_ONLY_KEYS = new Set([
  "PHOENIX_KEYPAIR_PATH", "NADO_KEY_PATH", "LIGHTER_API_PRIVATE_KEY_FILE", "LIGHTER_PYTHON",
  "PHOENIX_KEYPAIR_PATH_2", "NADO_KEY_PATH_2", "LIGHTER_API_PRIVATE_KEY_FILE_2",
  "PHOENIX_KEYPAIR_PATH_3", "NADO_KEY_PATH_3", "LIGHTER_API_PRIVATE_KEY_FILE_3",
]);
